...
Pour la planification initiale, l'objectif était de travailler en cascade tout du long. Cependant, ce plan a évolué lors de la réalisation de ce projet. En effet, travailler en cascade a été planifié jusqu'à la réalisation d'une version minimal, suite a quoi une implémentation par itération sera utilisée pour les fonctionnalités supplémentaires.

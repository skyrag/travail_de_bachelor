...
Le projet a pour but de créer un jeu ayant un style similaire à des jeux comme TeamfightTactics ou Hearstone battleground mais en le personnalisant pour garantir la différence. L'objectif n'est en aucun cas de créer quelque chose de révolutionnaire, mais de créer un jeu fonctionnel avec lequel les joueurs s'amuseront avec des personnages de la pop-culture. On cherche donc à réaliser un jeu jouable en ligne multijoueur auto-battler, où 8 personnes pourront s'affronter dans la même partie.
#v(2em)
#v(2em)
...
=== Should have
-	Un système de classe et de famille pour les unités : au-delà d'avoir une unité, en avoir plusieurs différentes de la même classe ou famille devrait accorder un bonus (cf. le game design document en annexe).
-	Une liste des d'unités disponible suffisamment grande : même si cela est assez subjectif, on va partir sur une base de 40 unités différentes qui seraient jouables
-	Une interaction spécifique lors de l'utilisation de chaque famille : s'il y a suffisamment d'unités différentes d'une même famille dans une équipe, cela devrait apporter une mécanique nouvelle lors des combats. Et le bonus ou la mécanique de classe devrait faire écho aux sources originelles.
#v(2em)

=== Could have
-	Un système d'amélioration pendant la partie : durant la partie plusieurs choix aléatoires sont proposés aux joueurs afin d'améliorer leur équipe ou de changer leur partie actuelle
...
-	Une intelligence artificielle complexe et challengeante, qui pourrait poser un vrai danger à des joueurs connaissant le jeu ou les jeux de ce genre
#v(2em)
...
-	remise du travail ainsi que le rapport des sources, une affiche et un résumé publiable pour GAPS le 24.07.2026 avant 11 h.
#v(2em)

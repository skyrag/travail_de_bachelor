...
L'implémentation du système de replay, même si la conception a été faite et qu'il y a une grosse parti de l'implémentation il manque une partie frontend et des messages acteur pour que la fonctionnalité soit utilisable.
Enfin, a cause des difficulté rencontrer, le frontend n'est pas entièrement fini et tester notemment la partie de combats.
...
Au-delà de l'aspect technique, ce projet représente le plus important que j'ai eu l'occasion de mener à ce jour, et il m'a permis d'apprendre énormément, tant sur le plan technique que méthodologique.
#v(1em)
